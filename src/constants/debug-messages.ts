// projects
export const PROJECT_LOADED = (project_id: string): string =>
  `Project loaded ${project_id}`;

// versions
export const VERSION_NOT_FOUND = (name: string): string =>
...
export const VERSION_WILL_BE_ARCHIVED = (name: string): string =>
  `Version ${name} found and is going to be archived`;
export const VERSION_CREATED = (name: string): string =>
  `Version ${name} was successfully created`;
export const VERSION_UPDATED = (name: string): string =>
  `Version ${name} was successfully updated`;
// tickets
export const UPDATING_TICKET = (ticket_id: string): string =>
  `Going to update ticket ${ticket_id}`;
